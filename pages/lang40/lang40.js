...
Page({
  data: {
    ...
    items1: [
      { name: "A", value: "寝ている状態で発生する" },
      { name: "B", value: "座位で発生する" },
      { name: "C", value: "出歩く（動くと）と喘息になる/息苦しい" },
      { name: "D", value: "無し" },
    ],
    items2: [
      { name: "A", value: "吐き気がして嘔吐する" },
      { name: "B", value: "下痢です" },
      { name: "C", value: "いいえ" },
    ],
    items3: [
