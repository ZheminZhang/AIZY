...
Page({
  data: {
    ...
    timestamp: "",
    items: [
      { name: "A", value: "Dry cough (without phlegm)" },
      { name: "B", value: "Cough (with phlegm)" },
      { name: "C", value: "Coughing badly" },
      { name: "D", value: "No coughing symptom" },
    ],
    items1: [
      { name: "A", value: "Difficulty in breathing while lying down" },
      { name: "B", value: "Difficulty in breathing while sitting" },
      { name: "C", value: "Difficulty in breathing while walking" },
      { name: "D", value: "No difficulty in breathing" },
    ],
    items2: [
      { name: "A", value: "feeling nausea and vomit" },
      { name: "B", value: "diarrhea" },
      { name: "C", value: "No gastrointestinal disorder symptoms" },
    ],
    items3: [
      { name: "A", value: "Yes" },
      { name: "B", value: "No" },
    ...
    items6: [
      { name: "A", value: "My body temperature is normal" },
      { name: "B", value: "Low fever (37.2-38℃)" },
      { name: "C", value: "High fever (above 38 ℃)" },
    ],
    items7: [
      { name: "A", value: "Yes" },
      { name: "B", value: "No" },
  ...
  checkQuestion: function () {
    ...
    if (
      ...
      wx.showToast({
        title: "Readings from the last three body temperature measurements(℃)",
        icon: "none",
      });
      return false;
    }
    ...
    if (this.data.item2Value == "") {
      wx.showToast({
        title: "Do you have the following gastrointestinal disorder symptoms?",
        icon: "none",
      });
      return false;
    }
    ...
    if (this.data.item4Value == "") {
      wx.showToast({
        title: "Do you feel weak and have body pain?",
        icon: "none",
      });
      return false;
    }
    if (this.data.item5Value == "") {
      wx.showToast({
        title: "Do you sneeze or have a runny nose?",
        icon: "none",
      });
      return false;
    }
    if (this.data.item6Value == "") {
      wx.showToast({
        title: "Do you have a fever? What's your fever temperature?",
        icon: "none",
      });
      return false;
    }
    ...
    if (this.data.item7Value == "") {
      wx.showToast({
        title: "Is there a thick layer of tongue coating on your tongue?",
        icon: "none",
      });
      return false;
    }
    if (this.data.zhouWei == "") {
      wx.showToast({
        title: "The number of days that the above symptoms persist",
        icon: "none",
      });
      return false;
    }
    ...
    if (this.data.item9Value == "") {
      wx.showToast({
        title: "Do you have any contact with known Wuhan personnel?",
        icon: "none",
      });
      return false;
    }
